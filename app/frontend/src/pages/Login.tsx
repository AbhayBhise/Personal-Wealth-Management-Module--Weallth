...
export default function Login() {
  ...
  const [email, setEmail] = useState('client@weallth.demo');
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh' }}>
      <div className="glass-panel" style={{ maxWidth: '420px', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h2 style={{ margin: '0 0 0.25rem', fontSize: '1.75rem', fontWeight: 700, color: 'var(--accent-primary)' }}>Weallth PWM</h2>
        ...
        <div style={{ marginTop: '1.5rem', padding: '0.75rem 1rem', background: 'rgba(255,255,255,0.04)', borderRadius: '8px', fontSize: '0.75rem', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
          ...
          Client: <code>client@weallth.demo</code> / <code>demo1234</code><br />
          Advisor: <code>advisor@weallth.demo</code> / <code>demo1234</code>
        </div>
